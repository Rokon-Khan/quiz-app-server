...
export const createQuestionSchema = z.object({
  body: z.object({
    ...
    question_type: z.enum(["multiple_choice", "checkbox", "yes_no"] as const, {
      message: "Question type must be multiple_choice, checkbox, or yes_no",
    }),
...
export const updateQuestionSchema = z.object({
  ...
  body: z.object({
    question_type: z
      .enum(["multiple_choice", "checkbox", "yes_no"] as const, {
        message: "Question type must be multiple_choice, checkbox, or yes_no",
      })
      .optional(),
